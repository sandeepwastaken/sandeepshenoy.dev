...
Do not use simple vocab at all. Do not use words that are simply not common, they must be challenging, just like the question itself. Avoid reusing these words: ${avoidList.join(', ')}
